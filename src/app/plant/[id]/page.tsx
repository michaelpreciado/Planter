      ...
      <div className="flex-1 px-6 pb-safe overflow-y-auto mobile-scroll momentum-scroll" style={{ touchAction: 'pan-y' }}>
        ...
        >
          <button
            ...
            className="bg-primary text-primary-foreground py-6 rounded-xl text-lg font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-3"
          >
          ...
          <Link
            href="/list"
            className="bg-secondary text-secondary-foreground py-6 rounded-xl text-lg font-semibold hover:bg-secondary/80 transition-colors flex items-center justify-center gap-3"
          >
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
