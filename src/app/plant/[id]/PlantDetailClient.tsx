...
export default function PlantDetailClient({ id }: PlantDetailClientProps) {
    ...
    return (
      <div className="min-h-screen bg-background dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">Plant ID: {id}</p>
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-gray-900 flex flex-col relative ios-safe-layout mobile-content">
      {/* Water Animation */}
      <WaterAnimation 
      ...
      <motion.header 
        ...
        className="top-header-fixed flex items-center justify-between px-6 py-4 pt-safe bg-transparent backdrop-blur-xl"
        style={{ 
      ...
      {/* Main Content */}
      <div className="flex-1 px-6 pb-safe overflow-y-auto mobile-scroll momentum-scroll content-with-header content-with-nav" style={{ touchAction: 'pan-y' }}>
        {/* Status Card */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
